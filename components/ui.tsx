...
export function Ticker() {
  const items = ["✦ 2,200+ Happy Clients","✦ 89 Industries Served","✦ Founder-Led Team","✦ Post-Pay Available","✦ 100% Satisfaction","✦ +91 85869 89832","✦ Posters from ₹149","✦ Reels from ₹380","✦ Dashboards from ₹2,000","✦ No Lock-In Contracts"];
