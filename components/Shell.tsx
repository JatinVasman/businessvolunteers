      ...
      <footer style={{ background: T.ink, padding: "48px 24px 26px" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 32, marginBottom: 30 }}>
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.55)", fontSize: 12.5, maxWidth: 240, lineHeight: 1.8, marginBottom: 16 }}>89 industries. 2,700+ clients. Premium digital marketing from Noida Sector 62, Delhi NCR.</p>
            <SocialIconRow dark />
          </div>
          <div>
