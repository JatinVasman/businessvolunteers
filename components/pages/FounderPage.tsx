...
export { default as HarshFounderPageOld } from "./FounderPageOld";

function FounderPage({ go }: { go: any }) {
    ...
    <div style={{ paddingTop: 36 }} ref={ref}>
        ...
        <div style={{ background: T.bg2, border: `1px solid ${T.cardBGold}`, borderRadius: 28, padding: "44px 40px", marginBottom: 30, position: "relative", overflow: "hidden", boxShadow: `0 24px 60px ${T.shadow}` }}>
          ...
          <div className="bv-hero-flex">
            <div className="bv-hero-image" style={{ width: 150, height: 150, borderRadius: "50%", background: T.gradLux, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontFamily: T.serif, fontSize: 46, fontWeight: 800, flexShrink: 0, boxShadow: `0 18px 44px ${T.shadowWarm}`, overflow: "hidden" }}>
              <img src={FOUNDER_IMG} alt="Jatin Vasman" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%" }} />
            </div>
            <div style={{ flex: 1, minWidth: 260 }}>
              <Eyebrow>Founder & CEO</Eyebrow>
              <h1 style={{ fontFamily: T.serif, fontSize: "clamp(28px,4vw,42px)", fontWeight: 700, color: T.ink, margin: "0 0 10px", letterSpacing: -.5 }}>Jatin Vasman</h1>
              <p style={{ color: T.text2, fontSize: 15.5, lineHeight: 1.8, margin: "0 0 20px", maxWidth: 580, fontFamily: T.serif, fontStyle: "italic" }}>
                "Great businesses deserve great marketing and high-performance web platforms — my mission is to make every brand we work with unstoppable."
              </p>
              <div className="bv-hero-cta">
                <a href="https://www.linkedin.com/in/jatin-vasman?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" style={btnDark}>Connect on LinkedIn</a>
                <button onClick={() => go("contact")} style={btnGhost}>Work with Jatin →</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <FadeIn>
        <div style={{ background: T.bg2, border: `1px solid ${T.cardB}`, borderRadius: 22, padding: 32, marginBottom: 24, boxShadow: `0 10px 32px ${T.shadow}` }}>
          ...
          <p style={{ color: T.text2, fontSize: 14.5, lineHeight: 1.95, margin: "0 0 14px" }}>
            I started Business Volunteers because I saw so many small brands bursting with potential yet left behind by big agencies' one-size-fits-all approach. From Day 1, my philosophy has been simple: <strong style={{ color: T.ink }}>great businesses deserve great marketing and high-performance digital solutions.</strong> By combining data-driven insights with modern web development, we help our clients not just reach new customers, but build lasting brand loyalty.
          </p>
          <p style={{ color: T.text2, fontSize: 14.5, lineHeight: 1.95, margin: 0 }}>
            My journey began with a <strong style={{ color: T.ink }}>B.Tech in Computer Science</strong> — a technical foundation that gave me deep expertise in <strong style={{ color: T.ink }}>Web Development</strong>, software architecture, and digital product building. Years of hands-on full-stack development, performance optimization, and digital strategy taught me how engineering and marketing intersect to move businesses forward. Today, after guiding 2,700+ companies to growth, I still roll up my sleeves on every web development and strategy project — treating each client's business as my own.
          </p>
        </div>
      </FadeIn>

      {/* Philosophy */}
      <SectionHead eyebrow="Leadership Philosophy" title="Three Pillars of How Jatin Works" />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(250px,1fr))", gap: 16, marginBottom: 44 }}>
        {[
          ...
          { icon: "💻", t: "Web Development Expertise", d: "Rooted in a B.Tech in Computer Science, Jatin specializes in modern web development — crafting lightning-fast, high-converting digital web platforms tailored to client success." },
          { icon: "⚡", t: "Bold Execution", d: "Strategy decks don't grow businesses; shipped code and active campaigns do. Weekly sprints, clean development cycles and aggressive optimization turn plans into ROI." },
        ].map((p, i) => (
      ...
      <div style={{ marginBottom: 44 }}>
        {[
          { y: "Foundation", t: "Computer Science Education", d: "B.Tech in Computer Science — building the technical architecture and web development foundation that powers our digital engineering studio." },
          { y: "Apprenticeship", t: "Web Development & Performance Engineering", d: "Years building custom web platforms, e-commerce solutions, web apps, and performance dashboards — mastering modern tech stacks from the inside." },
          { y: "2025", t: "Business Volunteers Founded", d: "Launched in Noida Sector 62 & New Ashok Nagar, Delhi, 110096 with a singular mission: make every brand unstoppable through affordable web development and accountable marketing." },
          { y: "2026", t: "2,700+ Clients · 89 Industries", d: "Featured profiles on Medium, a 4.9★ client rating, and signature offerings like custom web development & KPI Dashboard Systems setting the agency apart." },
        ].map((m, i) => (
      ...
      {/* Notable projects */}
      <SectionHead eyebrow="Proof of Work" title="Signature Campaigns & Web Platforms" sub="A few results Jatin has personally led — explore the full library for the complete picture." />
        ...
        <FadeIn>
          <div style={{ background: T.bg2, border: `1px solid ${T.cardB}`, borderRadius: 18, padding: 26, height: "100%", boxShadow: `0 8px 24px ${T.shadow}` }}>
            ...
            <p style={{ color: T.text2, fontSize: 13.5, lineHeight: 1.8, margin: 0 }}>
              Jatin writes on web development architectures, founder-led marketing, AI-era SEO and data-driven growth — with featured profiles on Medium and an active voice on LinkedIn. He regularly trains client engineering and marketing teams on performance dashboards.
            </p>
          </div>
        </FadeIn>
        <FadeIn delay={70}>
          <div style={{ background: T.bg2, border: `1px solid ${T.cardB}`, borderRadius: 18, padding: 26, height: "100%", boxShadow: `0 8px 24px ${T.shadow}` }}>
            ...
            <p style={{ color: T.text2, fontSize: 13.5, lineHeight: 1.8, margin: 0 }}>
              Off the clock, Jatin is a systems-builder and coder at heart — exploring new web dev frameworks, UI design trends, and building tools that empower Indian businesses to thrive online.
            </p>
          </div>
        </FadeIn>
      </div>
      ...
      <FadeIn>
        <div style={{ background: T.ink, borderRadius: 26, padding: "42px 34px", textAlign: "center", position: "relative", overflow: "hidden" }}>
          ...
          <h3 style={{ color: "#fff", fontFamily: T.serif, fontSize: 26, fontWeight: 700, margin: "0 0 10px" }}>Build Your Growth & Web Platform with Jatin</h3>
