    ...
    <div style={{ paddingTop:36 }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(270px,1fr))", gap:22, marginBottom:48 }}>
        {[
          ...
          { n:"Growth", p:"₹5,999", per:"/mo", badge:"Most Popular", f:["3 Social Platforms","20 Posts/Month","5 Reels Edited","3 Festival Posters","Meta Ads Setup","Monthly Strategy Call"] },
          { n:"Pro", p:"₹8,999", per:"/mo", badge:"Best ROI", f:["4 Social Platforms","30 Posts/Month","8 Reels Edited","6 Festival Posters","Full Meta Ads Management","Google My Business","Weekly Report"] },
        ].map((pkg,i)=>(
