      ...
      <FadeIn>
        <div style={{ background:T.bg2, border:`1px solid ${T.cardBGold}`, borderRadius:28, padding:"44px 40px", marginBottom:30, position:"relative", overflow:"hidden", boxShadow:`0 24px 60px ${T.shadow}` }}>
          ...
          <div className="bv-hero-flex">
            <div className="bv-hero-image" style={{ width:150, height:150, borderRadius:"50%", background:T.gradGold, display:"flex", alignItems:"center", justifyContent:"center", color:T.ink, fontFamily:T.serif, fontSize:46, fontWeight:800, flexShrink:0, boxShadow:`0 18px 44px ${T.shadow}`, overflow:"hidden" }}><img src={COFOUNDER_IMG} alt="Khwahish Sahai" style={{ width:"100%", height:"100%", objectFit:"cover", borderRadius:"50%" }} /></div>
