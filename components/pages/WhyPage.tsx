...
function WhyPage({ go }) {
  return (
    <div style={{ paddingTop:36 }}>
      ...
      <SectionHead eyebrow="The Difference" title="Why Business Volunteers?" sub="Four honest reasons 2,200+ businesses chose us — and stayed." />
      ...
      <FadeIn>
        <div style={{ background:T.ink, borderRadius:20, padding:"24px 28px", marginBottom:48, display:"flex", gap:20, alignItems:"center", flexWrap:"wrap", justifyContent:"center" }}>
          <span style={{ color:T.goldLight, fontFamily:T.serif, fontSize:18, fontWeight:700 }}>Over 2,200 businesses trust us</span>
