...
function AboutOverview({ go }) {
  ...
  return (
    <div style={{ paddingTop:36 }} ref={ref}>
      ...
      <FadeIn>
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))", background:T.ink, borderRadius:22, overflow:"hidden", marginBottom:30 }}>
          {[{n:"2200+",l:"Happy Clients"},{n:"89",l:"Industries"},{n:"300+",l:"Projects Delivered"},{n:"4.9★",l:"Average Rating"}].map((s,i)=>(
            <div key={i} style={{ borderRight:i<3?"1px solid rgba(255,255,255,0.1)":"none", padding:"28px 14px", textAlign:"center" }}>
