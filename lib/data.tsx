...
export const SERVICES = [
  ...
  { id:"smm", icon:"📱", n:"Social Media Marketing", p:"₹3,499–₹8,999/mo", isFirst:true,
    ...
    faqs:[
      ...
      ["How many posts and reels per month?","Starter: 12 posts + 2 reels. Growth: 20 posts + 4 reels. Pro: 30 posts + 8 reels. All plans include stories and festival creatives."],
...
export const PATHS = { home:"/", "about-overview":"/about", founder:"/founder",
...
export function pathToKey(p){
  ...
  const map={ "/about":"about-overview","/founder":"founder","/co-founder":"cofounder",
